...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Sondierungstiefen Zahn 3 2 3 2 2 3", "Sondierungstiefen Zahn 3 2 3 2 2 3", []),
        ("PSI Zahn 2 3 2 2", "PSI Zahn 2 3 2 2", []),
        ("Sondierungstiefen 4 5 4 mm. Zahn drei sechs drei sieben Karies",
         "Sondierungstiefen 4 5 4 mm. Zahn 36 37 Karies", [36, 37]),
        ("1 6 2 6", "1 6 2 6", []),
        ("Regio 3 6 3 7 Implantate", "Regio 36 37 Implantate", [36, 37]),
        ("Regio drei sechs drei sieben Implantate", "Regio 36 37 Implantate", [36, 37]),
        ("Zahn 36 und 37 Implantate", "Zahn 36 und 37 Implantate", [36, 37]),
        ("Regio drei sechs Implantate", "Regio 36 Implantate", [36]),
        ("Zahn 36, 14 Tage nach Extraktion Schmerzen", "Zahn 36, 14 Tage nach Extraktion Schmerzen", [36]),
        ("Zahn 36 und 12 Wochen", "Zahn 36 und 12 Wochen", [36]),
        ("Zahn 36 14 Tage", "Zahn 36 14 Tage", [36]),
        ("Zahn 16, 26 Jahre", "Zahn 16, 26 Jahre", [16]),
        ("36 37 Zähne", "36 37 Zähne", [36]),
        ("Sondierungstiefen 3, 2, 3, 2, 2, 3", "Sondierungstiefen 3, 2, 3, 2, 2, 3", []),
