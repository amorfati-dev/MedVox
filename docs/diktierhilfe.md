...
Bisher bestätigt: l1 (41a), wf (35), ost1 (47a, GOZ 3030), opg (Ä935d, GOÄ Ä5004), pan1 (Ä935a,
GOÄ Ä5002) – die Liste wächst mit den Meldungen aus dem Praxisalltag. Mehrfach erbrachte Positionen
stehen einmal mit Anzahl: drei Kanäle an 36 → `36,wf*3`. Die Chips zeigen beides („41a · l1").
